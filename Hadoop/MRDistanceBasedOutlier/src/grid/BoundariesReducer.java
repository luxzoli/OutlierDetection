...
public class BoundariesReducer extends Reducer<IntWritable, Text, IntWritable, Text> {
	...
	public void reduce(IntWritable key, Iterable<Text> values, Context context)
		...
		while (iter.hasNext()) {
			...
			// TODO:if d and the number of tokens do not match, there is a problem
			...
			StringTokenizer st = new StringTokenizer(valueString.substring(valueString.indexOf("\t") + 1), " ");
			for (int i = 0; i < d; i++) {
