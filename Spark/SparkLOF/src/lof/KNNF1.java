...
public class KNNF1 implements PairFlatMapFunction<Tuple2<Integer, Iterable<Point>>, Integer, Point> {
	private int k;
	...
	@Override
	public Iterable<Tuple2<Integer, Point>> call(Tuple2<Integer, Iterable<Point>> arg0) throws Exception {
		...
		for (Point point : points) {
			float kDistance = KDTree.exclusiveKNNQuery(tree, point, k, neighbors);
