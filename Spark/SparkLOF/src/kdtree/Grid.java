...
public class Grid implements Serializable {
	...
	public static void rangeSearch(Grid node, float[] lowerBoundary,
			float[] upperBoundary, ArrayList<Grid> nodesInRange) {
		rangeSearch(node, lowerBoundary, upperBoundary, nodesInRange, 0);
	}

	private static void rangeSearch(Grid node, float[] lowerBoundary,
			float[] upperBoundary, ArrayList<Grid> nodesInRange, int level) {
	...
	public static void epsilonNeighborhood(Grid node, Point p, float epsilon,
	...
	public static void getMatchingGrids(Grid grid, Point point, float epsilon,
